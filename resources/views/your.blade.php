...
@section('content')
    ...
    <div class="container-fluid" style=" height: calc(100% - 65px); ">
        <div class="row h-100 w-100" style="margin-right: 0px;">
                ...
                <div class="ml-auto"
                     style="width: calc(100vw - 250px);overflow: auto; height: 100%; overflow-x: hidden;">
                    <div class="d-flex justify-content-center">
                        <div>
                            <h1 class="font p-5" style="font-size: calc( 2vw + 10px);">Your Products</h1>
                        </div>
                    </div>
                                ...
                                @foreach($products as $product)
                                    <div class="product shadow m-4">
                                        ...
                                        <div class="d-flex  bd-highlight" style="margin-top: 15px">
                                            ...
                                            <div class="bd-highlight ml-auto mt-4 pr-5 row">


                                                <a href="/home/{{$product->id}}/edit">
                                                    <button type="button"
                                                            class="rounded-circle border-0 font mr-3 text-white font-weight-bold "
                                                            style="font-size: 18px;background-color: #FFDC52; width: 30px; height: 30px">
                                                        <img src="/images/edit2.svg" alt="edit icon" width="18px"
                                                             height="18px">
                                                    </button>
                                                ...
                                                <form action="{{action('ProductController@destroy', $product->id)}}"
                                                    ...
                                                    <button type="submit"
                                                            ...
                                                            class="rounded-circle border-0 font text-white font-weight-bold "
                                                            style="background-color: #FF8383; width: 30px; height: 30px">
                                                        <img
                                                            src="/images/trash.svg" alt="edit icon" width="15px"
                                                            height="15px">
                                                    </button>
                                                </form>
                                            </div>
